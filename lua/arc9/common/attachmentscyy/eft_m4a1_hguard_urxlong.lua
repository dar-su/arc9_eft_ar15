...
ATT.CompactName = "URX-10"
ATT.Description = [[Knights Armament URX 3.1 handguard for AR-15 equipped with a unique interface for installation of additional devices and accessories.]]

ATT.Icon = Material("entities/eft_attachments/hguard/eft_hguard_ar15_urxlong.png", "mips smooth")

ATT.Model = "models/weapons/arc9_eft_m4a1/atts/hguard/eft_m4a1_hguard_urxlong.mdl"
