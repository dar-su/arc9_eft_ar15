...
ENT.PrintName  = "40x46 M386 Projectile"

local modela   = "models/weapons/arc9/darsu_eft/40x46_m386.mdl"
local radius   = 3.8 * 2
local damgae   = 199
local fusetime = 0.26
...
if CLIENT then    
    ...
    function ENT:Explode()
        ...
        self:EmitSound("weapons/darsu_eft/m203/gren_expl2_close.ogg", 70, nil, nil, nil, nil, 1)
        self:EmitSound("weapons/darsu_eft/m203/gren_expl2_dist1.ogg", 90, nil, nil, nil, nil, 1)
        self:EmitSound("weapons/darsu_eft/m203/gren_expl2_dist2.ogg", 999, nil, nil, nil, nil, 1)
        self:Remove()
    end
